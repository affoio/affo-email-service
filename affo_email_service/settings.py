...
settings = LazySettings(
    ENVVAR_PREFIX_FOR_DYNACONF='AFFO_ES',
    ENVVAR_FOR_DYNACONF='AFFO_ES_SETTINGS',
)
...
SQLALCHEMY_MODEL_IMPORTS = (
    'affo_email_service.models.message',
    'affo_email_service.models.unsubscribe',
)

# CELERY CONFIGURATION
CELERY_BROKER_URL = settings.CELERY_BROKER_URL
CELERY_IMPORTS = (
    'affo_email_service.tasks.email',
)
